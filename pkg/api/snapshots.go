...
type SnapshotResponse struct {
	...
	LastPublishTaskUUID string            `json:"publish_task_uuid,omitempty"` // UUID of the publish/unpublish task
	LastPublishTask     *TaskInfoResponse `json:"publish_task,omitempty"`      // Status of the publish/unpublish task
