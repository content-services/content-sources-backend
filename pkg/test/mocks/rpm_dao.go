...
// RpmDao is an autogenerated mock type for the RpmDao type
type RpmDao struct {
	mock.Mock
}

// InsertForRepository provides a mock function with given fields: repoUuid, pkgs
func (_m *RpmDao) InsertForRepository(repoUuid string, pkgs []yum.Package) (int64, error) {
...
func (_m *RpmDao) List(orgID string, uuidRepo string, limit int, offset int, search string, sortBy string) (api.RepositoryRpmCollectionResponse, int64, error) {
...
func (_m *RpmDao) OrphanCleanup() error {
	ret := _m.Called()
...
func (_m *RpmDao) Search(orgID string, request api.SearchRpmRequest) ([]api.SearchRpmResponse, error) {
...
// NewRpmDao creates a new instance of RpmDao. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRpmDao(t mockConstructorTestingTNewRpmDao) *RpmDao {
	mock := &RpmDao{}
	mock.Mock.Test(t)
