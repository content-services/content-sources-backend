...
func (rh *RepositoryHandler) createUpload(c echo.Context) error {
	...
	if req.Resumable == nil {
		return ce.NewErrorResponse(http.StatusBadRequest, "Error creating upload", "Resumable field is required to be provided in the request body")
	}
	...
	// resumable=false or first time upload, returns new UUID
