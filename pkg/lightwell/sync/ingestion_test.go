...
func TestIngestorSyncPaginatesAndLoadsNewRelationships(t *testing.T) {
	...
	assert.Equal(t, []dao.LightwellVulnerabilityTicket{{TicketID: "EPIC-1", CustomerID: "123"}}, store.saved[0].Tickets)
...
func TestIngestorLoadsMultipleBatchRelationships(t *testing.T) {
	...
	assert.Equal(t, []dao.LightwellVulnerabilityTicket{
		{TicketID: "EPIC-1", CustomerID: "111"},
		{TicketID: "EPIC-2", CustomerID: "222"},
...
func TestIngestorStoresEpicFromBatchParent(t *testing.T) {
	...
	assert.Equal(t, []dao.LightwellVulnerabilityTicket{{TicketID: "EPIC-1", CustomerID: "789"}}, store.saved[0].Tickets)
}
