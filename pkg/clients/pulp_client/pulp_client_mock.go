...
func (_mock *MockPulpClient) GetMavenRepositoryMetrics(ctx context.Context, repoHref string) (zest.MavenRepositoryMetricsResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetMavenRepositoryMetrics")
	}

	var r0 zest.MavenRepositoryMetricsResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (zest.MavenRepositoryMetricsResponse, error)); ok {
		return returnFunc(ctx, repoHref)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) zest.MavenRepositoryMetricsResponse); ok {
		r0 = returnFunc(ctx, repoHref)
	} else {
		r0 = ret.Get(0).(zest.MavenRepositoryMetricsResponse)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string) error); ok {
...
// MockPulpClient_GetMavenRepositoryMetrics_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMavenRepositoryMetrics'
type MockPulpClient_GetMavenRepositoryMetrics_Call struct {
	*mock.Call
}

// GetMavenRepositoryMetrics is a helper method to define mock.On call
//   - ctx context.Context
//   - repoHref string
func (_e *MockPulpClient_Expecter) GetMavenRepositoryMetrics(ctx interface{}, repoHref interface{}) *MockPulpClient_GetMavenRepositoryMetrics_Call {
	return &MockPulpClient_GetMavenRepositoryMetrics_Call{Call: _e.mock.On("GetMavenRepositoryMetrics", ctx, repoHref)}
}

func (_c *MockPulpClient_GetMavenRepositoryMetrics_Call) Run(run func(ctx context.Context, repoHref string)) *MockPulpClient_GetMavenRepositoryMetrics_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockPulpClient_GetMavenRepositoryMetrics_Call) Return(mavenRepositoryMetricsResponse zest.MavenRepositoryMetricsResponse, err error) *MockPulpClient_GetMavenRepositoryMetrics_Call {
	_c.Call.Return(mavenRepositoryMetricsResponse, err)
	return _c
}

func (_c *MockPulpClient_GetMavenRepositoryMetrics_Call) RunAndReturn(run func(ctx context.Context, repoHref string) (zest.MavenRepositoryMetricsResponse, error)) *MockPulpClient_GetMavenRepositoryMetrics_Call {
	_c.Call.Return(run)
	return _c
}
...
// ListMavenPackageContent provides a mock function for the type MockPulpClient
func (_mock *MockPulpClient) ListMavenPackageContent(ctx context.Context, repoHref string, groupId string, artifactId string, baseVersion string) ([]zest.MavenMavenPackageResponse, error) {
	ret := _mock.Called(ctx, repoHref, groupId, artifactId, baseVersion)

	if len(ret) == 0 {
		panic("no return value specified for ListMavenPackageContent")
	}

	var r0 []zest.MavenMavenPackageResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string, string) ([]zest.MavenMavenPackageResponse, error)); ok {
		return returnFunc(ctx, repoHref, groupId, artifactId, baseVersion)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string, string) []zest.MavenMavenPackageResponse); ok {
		r0 = returnFunc(ctx, repoHref, groupId, artifactId, baseVersion)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]zest.MavenMavenPackageResponse)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, string, string) error); ok {
		r1 = returnFunc(ctx, repoHref, groupId, artifactId, baseVersion)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockPulpClient_ListMavenPackageContent_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListMavenPackageContent'
type MockPulpClient_ListMavenPackageContent_Call struct {
	*mock.Call
}

// ListMavenPackageContent is a helper method to define mock.On call
//   - ctx context.Context
//   - repoHref string
//   - groupId string
//   - artifactId string
//   - baseVersion string
func (_e *MockPulpClient_Expecter) ListMavenPackageContent(ctx interface{}, repoHref interface{}, groupId interface{}, artifactId interface{}, baseVersion interface{}) *MockPulpClient_ListMavenPackageContent_Call {
	return &MockPulpClient_ListMavenPackageContent_Call{Call: _e.mock.On("ListMavenPackageContent", ctx, repoHref, groupId, artifactId, baseVersion)}
}

func (_c *MockPulpClient_ListMavenPackageContent_Call) Run(run func(ctx context.Context, repoHref string, groupId string, artifactId string, baseVersion string)) *MockPulpClient_ListMavenPackageContent_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockPulpClient_ListMavenPackageContent_Call) Return(mavenMavenPackageResponses []zest.MavenMavenPackageResponse, err error) *MockPulpClient_ListMavenPackageContent_Call {
	_c.Call.Return(mavenMavenPackageResponses, err)
	return _c
}

func (_c *MockPulpClient_ListMavenPackageContent_Call) RunAndReturn(run func(ctx context.Context, repoHref string, groupId string, artifactId string, baseVersion string) ([]zest.MavenMavenPackageResponse, error)) *MockPulpClient_ListMavenPackageContent_Call {
	_c.Call.Return(run)
	return _c
}

// ListMavenPackages provides a mock function for the type MockPulpClient
func (_mock *MockPulpClient) ListMavenPackages(ctx context.Context, repoHref string, search string, limit int, offset int) (zest.PaginatedMavenRepositoryPackageListResponse, error) {
	ret := _mock.Called(ctx, repoHref, search, limit, offset)

	if len(ret) == 0 {
		panic("no return value specified for ListMavenPackages")
	}

	var r0 zest.PaginatedMavenRepositoryPackageListResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, int, int) (zest.PaginatedMavenRepositoryPackageListResponse, error)); ok {
		return returnFunc(ctx, repoHref, search, limit, offset)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, int, int) zest.PaginatedMavenRepositoryPackageListResponse); ok {
		r0 = returnFunc(ctx, repoHref, search, limit, offset)
	} else {
		r0 = ret.Get(0).(zest.PaginatedMavenRepositoryPackageListResponse)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, int, int) error); ok {
		r1 = returnFunc(ctx, repoHref, search, limit, offset)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockPulpClient_ListMavenPackages_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListMavenPackages'
type MockPulpClient_ListMavenPackages_Call struct {
	*mock.Call
}

// ListMavenPackages is a helper method to define mock.On call
//   - ctx context.Context
//   - repoHref string
//   - search string
//   - limit int
//   - offset int
func (_e *MockPulpClient_Expecter) ListMavenPackages(ctx interface{}, repoHref interface{}, search interface{}, limit interface{}, offset interface{}) *MockPulpClient_ListMavenPackages_Call {
	return &MockPulpClient_ListMavenPackages_Call{Call: _e.mock.On("ListMavenPackages", ctx, repoHref, search, limit, offset)}
}

func (_c *MockPulpClient_ListMavenPackages_Call) Run(run func(ctx context.Context, repoHref string, search string, limit int, offset int)) *MockPulpClient_ListMavenPackages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockPulpClient_ListMavenPackages_Call) Return(paginatedMavenRepositoryPackageListResponse zest.PaginatedMavenRepositoryPackageListResponse, err error) *MockPulpClient_ListMavenPackages_Call {
	_c.Call.Return(paginatedMavenRepositoryPackageListResponse, err)
	return _c
}

func (_c *MockPulpClient_ListMavenPackages_Call) RunAndReturn(run func(ctx context.Context, repoHref string, search string, limit int, offset int) (zest.PaginatedMavenRepositoryPackageListResponse, error)) *MockPulpClient_ListMavenPackages_Call {
	_c.Call.Return(run)
	return _c
}
