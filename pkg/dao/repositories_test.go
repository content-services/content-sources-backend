...
const testDeleteTablesQuery = `TRUNCATE repositories, snapshots, repositories_module_streams, repositories_rpms, repositories_package_groups, repositories_environments, repository_configurations, templates_repository_configurations, lightwell_advisories, lightwell_advisory_notifications, lightwell_advisory_releases`
