...
// InternalOnly_ListReposToSnapshot provides a mock function with given fields:
func (_m *MockRepositoryConfigDao) InternalOnly_ListReposToSnapshot() ([]models.RepositoryConfiguration, error) {
	ret := _m.Called()

	var r0 []models.RepositoryConfiguration
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]models.RepositoryConfiguration, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []models.RepositoryConfiguration); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
