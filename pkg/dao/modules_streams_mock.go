...
// MockModuleStreamsDao is an autogenerated mock type for the ModuleStreamsDao type
type MockModuleStreamsDao struct {
	mock.Mock
}

// SearchSnapshotModuleStreams provides a mock function with given fields: ctx, orgID, request
func (_m *MockModuleStreamsDao) SearchSnapshotModuleStreams(ctx context.Context, orgID string, request api.SearchSnapshotModuleStreamsRequest) ([]api.SearchModuleStreams, error) {
...
// NewMockModuleStreamsDao creates a new instance of MockModuleStreamsDao. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockModuleStreamsDao(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockModuleStreamsDao {
	mock := &MockModuleStreamsDao{}
	mock.Mock.Test(t)
