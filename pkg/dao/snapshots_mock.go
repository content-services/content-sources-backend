...
// Internal_Fetch provides a mock function with given fields: snapshotUUID
func (_m *MockSnapshotDao) Internal_Fetch(snapshotUUID string) (models.Snapshot, error) {
	ret := _m.Called(snapshotUUID)

	var r0 models.Snapshot
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (models.Snapshot, error)); ok {
		return rf(snapshotUUID)
	}
	if rf, ok := ret.Get(0).(func(string) models.Snapshot); ok {
		r0 = rf(snapshotUUID)
	} else {
