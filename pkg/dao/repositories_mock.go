...
// MockRepositoryDao is an autogenerated mock type for the MockRepositoryDao type
...
func NewMockRepositoryDao(t mockConstructorTestingTNewRepositoryDao) *MockRepositoryDao {
