...
// DeleteRpmPublication provides a mock function with given fields: ctx, versionHref
func (_m *MockPulpClient) DeleteRpmPublication(ctx context.Context, versionHref string) error {
	ret := _m.Called(ctx, versionHref)
