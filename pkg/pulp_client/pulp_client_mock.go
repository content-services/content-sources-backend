...
// UpdateRpmDistribution provides a mock function with given fields: rpmDistributionHref, rpmPublicationHref, distributionName, basePath
func (_m *MockPulpClient) UpdateRpmDistribution(rpmDistributionHref string, rpmPublicationHref string, distributionName string, basePath string) (string, error) {
	ret := _m.Called(rpmDistributionHref, rpmPublicationHref, distributionName, basePath)

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string, string) (string, error)); ok {
		return rf(rpmDistributionHref, rpmPublicationHref, distributionName, basePath)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, string) string); ok {
		r0 = rf(rpmDistributionHref, rpmPublicationHref, distributionName, basePath)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(string, string, string, string) error); ok {
		r1 = rf(rpmDistributionHref, rpmPublicationHref, distributionName, basePath)
	} else {
		r1 = ret.Error(1)
	}
