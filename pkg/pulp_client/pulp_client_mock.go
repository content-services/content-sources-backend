...
func (_m *MockPulpClient) CreateUpload(ctx context.Context, size int64) (*zest.UploadResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) (*zest.UploadResponse, error)); ok {
		return rf(ctx, size)
	}
...
func (_m *MockPulpClient) FinishUpload(ctx context.Context, uploadHref string, sha256 string) (*zest.AsyncOperationResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*zest.AsyncOperationResponse, error)); ok {
...
func (_m *MockPulpClient) UploadChunk(ctx context.Context, uploadHref string, contentRange string, file *os.File, sha256 string) (*zest.UploadResponse, error) {
	...
	var r0 *zest.UploadResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, *os.File, string) (*zest.UploadResponse, error)); ok {
