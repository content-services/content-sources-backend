...
ifeq ($(DEPLOY_PULP),true)
	PULP_COMPOSE_COMMAND=$(PULP_COMPOSE_OPTIONS) $(DOCKER)-compose  -f $(PULP_COMPOSE_FILES) up --detach
	PULP_COMPOSE_DOWN_COMMAND=$(PULP_COMPOSE_OPTIONS) $(DOCKER)-compose  -f $(PULP_COMPOSE_FILES) down

else
	PULP_COMPOSE_COMMAND=echo "Skipping pulp deploy, set DEPLOY_PULP=true to deploy"
	PULP_COMPOSE_DOWN_COMMAND=$(PULP_COMPOSE_COMMAND)
endif
