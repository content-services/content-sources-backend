...
openapi-lightwell: install-swag ## Regenerate lightwell openapi spec
	$(SWAG) init --output api/lightwell --generalInfo api.go --dir pkg/handler/lightwell/ --pd pkg/api,pkg/errors --instanceName lightwell --packageName lightwell
	# Convert from swagger to openapi
	go run ./cmd/swagger2openapi/main.go api/lightwell/swagger.json api/lightwell/openapi.json
	rm ./api/lightwell/swagger.json ./api/lightwell/swagger.yaml
