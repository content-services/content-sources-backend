...
const docTemplate = `{
    ...
    "paths": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.SnapshotPublishedUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/repositories/{uuid}/rpms/bulk_remove/": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.BulkRemoveRpmsRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "api.BulkRemoveRpmsRequest": {
            "type": "object",
            "properties": {
                "rpm_uuids": {
                    "description": "Rpms to delete from upload repository",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "api.SnapshotPublishedUpdateRequest": {
            ...
            "properties": {
                "published": {
                    "description": "Update snapshot published status to this value.",
                    "type": "boolean"
                }
            }
        },
